...
const HistoriaAcademica = () => {
  return (
    ...
    <div>
    <div className='mx-80'>
          <h1 className="text-[#0088cc] font-bold text-2xl ">Historia académica</h1>
          <div className=" border-t-gray-100 border"/>
      </div>

    <div className='flex justify-center my-4'>
    <div className=' w-[870px] h-[auto]'>

      <div>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            ARQUITECTURA I (13-00007)
            </h1>
        </div>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            ARQUITECTURA PAISAJISTA (13-00036)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            ESTRATEGIAS DE APRENDIZAJE (13-00305)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Examen</span>- A (Aprobado) Promocionado 02/03/2017
            </p>
        </div>
      </div>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            ESTRUCTURAS I (13-00013)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Examen</span>-7 (Siete) Aprobado 28/11/2018
            </p>
        </div>
      </div>
      ...
      <div className='my-4'>
        ...
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Promoción</span>-7 (Siete) Promocionado 30/06/2017
            </p>
        </div>
      </div>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            HISTORIA DE LA ARQUITECTURA I (13-00014)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            HISTORIA DE LA ARQUITECTURA II (13-00025)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            HISTORIA DE LA ARQUITECTURA III (13-00034)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
      ...
      <div className='my-4'>
        ...
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Equivalencia Total</span>- A (Aprobado) Aprobado 27/04/2022
            </p>
        </div>
      </div>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            INTRODUCCION A LA HISTORIA DE LA ARQUITECTURA Y EL URBANISMO (13-00003)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Examen</span>-  6 (Seis) Aprobado 05/12/2018
            </p>
            <p>
            <span className='font-bold'>Regularidad</span>- Aprobado 20/10/2017
            </p>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            INTRODUCCION A LA PROBLEMATICA DEL DISEÑO Y SU EXPRESION (13-00304)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Promoción</span>-  A (Aprobado) Promocionado 02/03/2017
            </p>
        </div>
      </div>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            INTRODUCCION A LA TECNOLOGIA (13-00051)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Examen</span>- 5 (Cinco) Aprobado 01/12/2017
            </p>
            <p>
            <span className='font-bold'>Regularidad</span>- Aprobado 20/10/2017
            </p>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            PRACTICA PROFESIONAL ASISTIDA (13-00049)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            SISTEMAS GRAFICOS DE EXPRESION (13-00004)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
      ...
      <div className='my-4'>
        <div className='bg-[#3a97ad] rounded'>
            <h1 className='font-bold text-white px-2'>
            TALLER DE INVESTIGACION EN ARQUITECTURA, URBANISMO Y DISEÑO. ELABORACION DE PROYECTOS. (13-00165)
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
            <span className='font-bold'>Promoción</span>- 8 (ocho) Promocionado 29/06/2022
            </p>
            <p>
            <span className='font-bold'>Regularidad</span>- RG (Regularizó) Aprobado 29/06/2022
            </p>
        </div>
      </div>
      ...
      <div className='my-4'>
        <div className=''>
            <h1 className='font-bold text-[#8d8d8d] px-2 text-xl'>
      ...
      <div className='my-4'>
        <div className=''>
            <h1 className='font-bold text-[#8d8d8d] px-2 text-xl'>
            Certificado: Bachiller Universitario en Ciencias Aplicadas 
            </h1>
        </div>
        <div className='my-2 px-2'>
            <p className='my-2'>
