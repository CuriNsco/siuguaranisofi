...
const InscripcionExamenes = () => {
  return (
    <div> <div><Navbar/>
    <SubNavbar/>
    <div className='mx-60'>
    <div>
          <h1 className="text-[#0088cc] font-bold text-2xl ">Inscripción a exámenes</h1>
      ...
      <div className='flex '>
        ...
        <div className=' mt-4 ml-8 border-2 border-t-white border-r-white py-2 px-2'>
          ...
          Seleccioná una actividad del listado para ver aquí las mesas a las que te podés inscribir 
          </p>
          </div>
        </div>
      </div>
...
export default InscripcionExamenes